...
-(void)awakeFromNib{
    ...
    [self  configUI];
    page = 0;
    self.headerView.withdrawal_label.text = [NSString  stringWithFormat:@"%.2f",model.withdrawSum];
    self.headerView.transfer_label.text = [NSString  stringWithFormat:@"%.2f",model.transferSum];
