    ...
    if (isNetworkingOK) {
        ...
        [manager POST:url parameters:mParameter progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
            ...
            if ([error.domain isEqualToString:AFURLResponseSerializationErrorDomain]) {
                // server error
                   NSHTTPURLResponse * urlResponse = (NSHTTPURLResponse *)error.userInfo[AFNetworkingOperationFailingURLResponseErrorKey];
                int code = 0;
